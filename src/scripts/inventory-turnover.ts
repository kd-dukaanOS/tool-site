...
Use this tool periodically to track inventory efficiency trends over time.` },
  ...
  examples: [
    ...
    { inputs: "COGS: ₹8,00,000, Beginning: ₹4,00,000, Ending: ₹4,00,000", result: "Turnover: 2x, Days: 183", explanation: "Slow-moving inventory signaling potential overstocking." },
  ],
  practicalUses: [
    ...
    "Deciding which product lines to discontinue or discount",
    "Setting realistic stock levels ahead of festive or peak seasons",
  ],
  expertTips: [
    ...
    "Use turnover data to negotiate better payment terms with suppliers for fast-moving items.",
    "Combine with gross margin to see which products are both fast-moving and profitable.",
  ],
  commonMistakes: [
    ...
    { mistake: "Treating all products as one aggregate ratio", fix: "Calculate turnover per SKU or category to spot specific slow-movers." },
  ],
  faq: [
    ...
    { q: "How often should I calculate inventory turnover?", a: "Monthly or quarterly tracking is common for active retail businesses, with an annual review for broader trend analysis." },
    { q: "Does inventory turnover differ by product category?", a: "Yes, perishable or fast-fashion items typically have much higher turnover than durable goods or specialty items." },
  ],
  relatedCalculators: ["Break Even Calculator", "Profit Margin Calculator", "GST Calculator", "ROI Calculator", "Sales Tax Calculator", "Payroll Calculator"],
