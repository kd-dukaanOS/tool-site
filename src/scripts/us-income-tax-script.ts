import { calculateUSIncomeTax, validateIncome, formatCurrency } from "../utils/regional-salary";
...
function renderBracketTable(breakdown: ReturnType<typeof calculateUSIncomeTax>["bracketBreakdown"]) {
...
function calculate() {
  ...
  const r = calculateUSIncomeTax(grossIncome);
  ...
  lastSummary = `US Federal Income Tax (Single Filer)\n\n` +
