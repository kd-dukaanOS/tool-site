export const gstCalculatorContent = {
  ...
  hero: {
    text: "The GST Calculator finds the GST amount, CGST, SGST and total price for any base amount and tax rate. Switch between GST-inclusive and GST-exclusive modes to instantly see the breakdown. Useful for business owners, freelancers and shoppers in India.",
  },

  about: {
    text: `The GST Calculator computes Goods and Services Tax on a given amount, splitting it into CGST and SGST, and shows the final total price.
...
Use this tool for quick invoice checks and GST slab comparisons.`,
  ...
  examples: [
    ...
    { inputs: "₹28000, 28% GST, exclusive", result: "Total: ₹35,840, GST: ₹7,840", explanation: "Highest GST slab, typically for luxury or sin goods." },
  ],
  ...
  practicalUses: [
    ...
    "Quoting client prices with correct tax breakdown",
    "Reconciling purchase orders against GST invoices",
    "Estimating landed cost of imported goods including GST",
  ],
  ...
  expertTips: [
    ...
    "Reverse charge mechanism may apply for certain services — check applicability separately.",
    "Round GST amounts consistently to avoid mismatches during reconciliation.",
  ],
  ...
  commonMistakes: [
    ...
    { mistake: "Not accounting for GST on discounted price", fix: "Apply GST after the discount has been deducted from the original price, not before." },
  ],
  ...
  faq: [
    ...
    { q: "Do I need to charge GST as a freelancer?", a: "If your annual turnover exceeds the prescribed threshold, GST registration and invoicing become mandatory; check current limits for your category." },
    { q: "Can GST be claimed back as input tax credit?", a: "Yes, registered businesses can typically claim input tax credit on GST paid for business purchases, subject to compliance rules." },
    { q: "How is GST calculated on a discounted item?", a: "GST is calculated on the price after the discount has been applied, not on the original pre-discount price." },
  ],

  relatedCalculators: ["Discount Calculator", "Percentage Calculator", "Break Even Calculator", "Currency Converter", "Sales Tax Calculator", "Invoice Due Date Calculator"],
