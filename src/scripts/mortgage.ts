...
Use this tool for home-buying budget planning, not as a final loan approval figure.` },
  ...
  examples: [
    ...
    { inputs: "Home: ₹80,00,000, Down: ₹20,00,000, 25yr, 8%", result: "Monthly P&I: ₹46,300", explanation: "Larger home loan with a longer 25-year term reducing monthly payment." },
  ],
  practicalUses: ["Estimating affordability before house-hunting", "Comparing loan offers from different lenders", "Understanding full cost including tax and insurance", "Deciding on down payment size to avoid PMI", "Budgeting for HOA fees in condo purchases", "Planning long-term homeownership costs", "Comparing 15-year vs 30-year term total cost", "Evaluating refinance affordability against current mortgage"],
  expertTips: ["A down payment of 20% or more typically avoids PMI.", "Compare total interest paid, not just monthly payment, across loan terms.", "Property tax rates vary significantly by location — use local rates.", "Shorter loan terms mean higher payments but far less total interest.", "Factor in maintenance costs beyond just the mortgage payment.", "Get pre-approved to know your realistic loan amount before house-hunting.", "Extra principal payments early in the loan term save the most total interest."],
  commonMistakes: [{ mistake: "Ignoring PMI when down payment is under 20%", fix: "Include PMI in your budget until you reach 80% loan-to-value." }, { mistake: "Forgetting property tax and insurance in affordability estimates", fix: "Always include full monthly payment, not just principal and interest." }, { mistake: "Choosing max loan term without checking total interest", fix: "Compare total interest cost across different term lengths." }, { mistake: "Not budgeting for maintenance and closing costs", fix: "Set aside funds beyond the mortgage payment for upkeep, repairs and one-time closing costs." }],
  faq: [
    ...
    { q: "Can I remove PMI once I have enough equity?", a: "Yes, once your loan-to-value ratio reaches around 80%, you can typically request PMI removal from your lender." },
    { q: "What is an HOA fee?", a: "HOA (Homeowners Association) fees cover shared community costs like maintenance, amenities and common area upkeep, common in condos and planned communities." },
  ],
  relatedCalculators: ["EMI Calculator", "Compound Interest Calculator", "Break Even Calculator", "Inflation Calculator", "FD Calculator", "NPS Calculator"],
