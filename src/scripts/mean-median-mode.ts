...
Use this tool for quick statistical analysis of any numeric dataset.` },
  ...
  examples: [
    ...
    { inputs: "1, 2, 2, 3, 3, 9", result: "Mean: 3.33, Median: 2.5, Mode: 2 & 3, Range: 8", explanation: "Bimodal dataset with two equally frequent values." },
  ],
  practicalUses: [
    ...
    "Summarizing repeated measurement data in experiments",
  ],
  expertTips: [
    ...
    "Compare mean and median together to quickly spot skewness in a dataset.",
    "Large sample sizes tend to give more stable and reliable central tendency measures.",
  ],
  commonMistakes: [
    ...
    { mistake: "Not sorting data before finding median manually", fix: "Median requires sorted data — this tool sorts automatically, but manual calculations must too." },
  ],
  faq: [
    ...
    { q: "Which measure is best for skewed data?", a: "Median is generally more reliable than mean for skewed distributions since it isn't pulled by extreme outlier values." },
    { q: "Is mode useful for numeric data?", a: "It's most useful for categorical or discrete numeric data with repeated values; for continuous data, mode may be less meaningful." },
  ],
  relatedCalculators: ["Average Calculator", "Standard Deviation Calculator", "Percentage Calculator", "GPA Calculator", "Ratio Calculator", "GCD Calculator"],
