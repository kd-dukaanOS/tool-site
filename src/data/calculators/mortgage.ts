...
Use this tool for home-buying budget planning, not as a final loan approval figure.` },
  ...
  faq: [
    ...
    { q: "How much house can I afford based on my income?", a: "A common guideline is keeping total monthly housing costs at or below 28-30% of gross monthly income, though this varies by lender and individual finances." },
    { q: "What happens when PMI is removed from my payment?", a: "Once your loan-to-value ratio reaches 80% through payments or appreciation, you can typically request PMI removal, lowering your monthly payment." },
    { q: "Does a higher interest rate change my loan qualification?", a: "Yes, higher rates increase your monthly payment, which can reduce the maximum loan amount lenders are willing to approve for your income." },
