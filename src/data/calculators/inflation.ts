...
Use this tool for long-term financial planning, not short-term budgeting.` },
  ...
  faq: [
   ...
   { q: "Can inflation ever be negative?", a: "Yes, this is called deflation, where prices fall over time, though it's relatively rare in most economies." },
    { q: "How often should I update my inflation rate assumption?", a: "Review it at least once a year, or whenever there's a major shift in your country's economic conditions, to keep long-term projections realistic." },
  ],
  relatedCalculators: ["CAGR Calculator", "SIP Calculator", "Compound Interest Calculator", "Retirement Calculator"],
