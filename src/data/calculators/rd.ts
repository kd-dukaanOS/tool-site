...
Use this tool to estimate RD returns before opening an account.` },
  ...
  faq: [
    ...
    { q: "Can I withdraw my RD before maturity?", a: "Yes, premature withdrawal is usually allowed but typically comes with a reduced interest rate or penalty compared to holding to maturity." },
    { q: "Is RD better than SIP for short-term savings?", a: "RD offers fixed, predictable returns ideal for short-term goals, while SIP in mutual funds carries market risk but potentially higher returns over longer periods." },
    { q: "Can I take a loan against my RD?", a: "Yes, many banks allow a loan or overdraft against your RD balance, usually up to 80-90% of the deposited amount." },
    { q: "Does the RD interest rate change during the tenure?", a: "No, most RDs lock in the interest rate at account opening, so it stays fixed for the entire tenure." },
    { q: "What is the minimum tenure for an RD?", a: "Most banks offer RD tenures starting from 6 months up to 10 years, though minimums can vary by bank." },
  ],
