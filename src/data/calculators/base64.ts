...
Use this tool for quick Base64 encoding or decoding tasks during development.` },
  ...
  faq: [
    ...
    { q: "What is the difference between Base64 and URL-safe Base64?", a: "Standard Base64 uses + and / characters, which have special meaning in URLs. URL-safe Base64 replaces them with - and _ so the string can be used directly in a URL or filename without escaping." },
    { q: "Why am I getting an error when decoding my Base64 string?", a: "This usually means the string is incomplete, has been copied with extra whitespace or line breaks, or is missing its padding '=' characters. Make sure you've copied the full, unmodified string." },
    { q: "Can I decode Base64 that contains emoji or special characters?", a: "Yes, this tool correctly handles Unicode text, so emoji, accented letters, and non-Latin scripts encode and decode without corruption." },
    { q: "Is Base64 the same as hashing?", a: "No. Hashing (like SHA-256) is one-way and can't be reversed, while Base64 is fully reversible — anyone can decode it back to the original text instantly." },
    { q: "How do I Base64 encode an image?", a: "This tool encodes text input. For images, you'd typically convert the image file to a byte string first, then encode that — a dedicated image-to-Base64 tool handles this conversion for you." },
    { q: "Why is Base64 used in JWT tokens?", a: "JWTs use Base64 (specifically Base64URL) to safely represent binary JSON header and payload data as compact, URL-friendly text, not to secure or encrypt the contents." },
  ],
