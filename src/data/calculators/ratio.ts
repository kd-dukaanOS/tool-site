...
Use this tool whenever you need to simplify or compare a two-part ratio quickly.` },
  ...
  faq: [
    ...
    { q: "What's an example of a ratio used in real life?", a: "Recipe scaling is common — a ratio of 2:1 flour to sugar stays proportional whether you're baking a small batch or a large one." },
    { q: "Can a ratio have more than two parts?", a: "Yes, ratios can compare three or more quantities (like 2:3:5), though this calculator simplifies two-part ratios at a time." },
    { q: "How is aspect ratio related to this calculator?", a: "Aspect ratio (like 16:9 for video) is a specific application of ratio simplification, describing the proportional relationship between width and height." },
    { q: "Why do two different ratios sometimes represent the same proportion?", a: "Ratios like 2:3 and 4:6 represent the same proportion because they simplify to the same lowest terms." },
  ],
