...
Use this tool to understand your salary breakdown; consult your HR or a tax professional for exact take-home after income tax.` },
  ...
  faq: [
    ...
    { q: "What is CTC and how does it relate to net salary?", a: "CTC (Cost to Company) includes gross salary plus employer-side contributions and benefits, which is typically higher than what appears as net take-home pay." },
    { q: "Is employer PF contribution part of my net salary?", a: "No, the employer's PF contribution is a separate cost to the company and isn't part of your monthly net take-home pay." },
    { q: "Can I reduce my PF deduction?", a: "Some employers allow adjusting the PF contribution rate above the statutory minimum, but reducing it typically requires employer policy or specific regulatory provisions." },
    { q: "Does professional tax apply in every state?", a: "No, professional tax is levied only in certain states in India, and rates vary where it does apply." },
    { q: "How often should I verify my payslip against a calculator like this?", a: "It's good practice to check whenever your salary structure changes, such as after a raise, promotion, or change in deduction policy." },
  ],
