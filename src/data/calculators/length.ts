...
Use this tool whenever you need a quick, accurate length conversion.` },
  ...
  faq: [
    ...
    { q: "How do I convert millimeters to inches?", a: "Divide the millimeter value by 25.4 to get the equivalent length in inches." },
    { q: "What is the difference between a nautical mile and a regular mile?", a: "A nautical mile (about 1.852 km) is longer than a standard mile (about 1.609 km) and is used mainly in aviation and maritime navigation." },
    { q: "How many meters are in a kilometer?", a: "There are exactly 1,000 meters in a kilometer." },
    { q: "How do I convert my height from feet and inches to centimeters?", a: "Convert feet to inches by multiplying by 12, add any extra inches, then multiply the total inches by 2.54 to get centimeters." },
    { q: "Why do some countries still use imperial units?", a: "Countries like the US primarily use imperial units due to historical convention, while most of the world adopted the metric system for international standardization." },
  ],
  relatedCalculators: ["Weight Converter", "Area Calculator", "Speed Converter", "BMI Calculator"],
