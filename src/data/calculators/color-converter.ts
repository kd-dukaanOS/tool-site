...
Use this tool whenever you need to quickly convert a color between web-standard formats.` },
  ...
  faq: [
    ...
    { q: "How do I convert RGB to HSL?", a: "Find the max and min of the R, G, B values (scaled 0-1), use them to compute lightness as their average, saturation from their difference relative to lightness, and hue based on which channel is highest — this tool automates that math instantly." },
    { q: "What does the 'A' in RGBA or HSLA stand for?", a: "Alpha, which controls transparency from 0 (fully transparent) to 1 (fully opaque) — useful for overlays, shadows, and semi-transparent UI elements in CSS." },
    { q: "Why does my color look different on different screens?", a: "Screen calibration, color profiles, and display technology (OLED vs LCD) can render the same HEX or RGB value slightly differently — this is a display characteristic, not an error in the conversion." },
    { q: "What is a web-safe color?", a: "Web-safe colors are a legacy set of 216 colors that displayed consistently on old 256-color monitors — with modern displays supporting millions of colors, this concept is largely obsolete today." },
    { q: "How do I find the HEX code for a color I see in an image?", a: "You'd need a color picker or eyedropper tool to sample the pixel first; this calculator converts a color value you already have between HEX, RGB, and HSL formats." },
    { q: "Can I use this tool to check if a color is light or dark?", a: "The HSL lightness value gives a rough indication — values above 50% lean lighter, below 50% lean darker — though for accessibility contrast checks, a dedicated contrast ratio tool is more precise." },
  ],
