...
Use this tool to estimate long-term PPF growth for tax-saving and retirement planning.` },
  ...
  faq: [
    ...
    { q: "Can I take a loan against my PPF balance?", a: "Yes, loans are available between the 3rd and 6th financial year, up to 25% of the balance at the end of the 2nd year before the loan year." },
    { q: "What happens if I miss a yearly PPF deposit?", a: "The account becomes inactive, but can be reactivated by paying a small penalty plus the minimum deposit for each missed year." },
    { q: "Can I open more than one PPF account?", a: "No, an individual can hold only one PPF account, except a guardian account opened on behalf of a minor." },
    { q: "Is PPF a good option compared to mutual funds?", a: "PPF offers guaranteed, tax-free returns with government backing, while mutual funds carry market risk but potentially higher long-term growth — the right choice depends on your risk appetite." },
    { q: "What happens to PPF after the 15-year lock-in ends?", a: "You can withdraw the full amount, or extend the account in blocks of 5 years, with or without making further contributions." },
  ],
