...
Use this tool whenever you need to quickly compare an old and new value in percentage terms.` },
  ...
  faq: [
    ...
    { q: "How do I reverse a percentage increase to find the original value?", a: "Divide the new value by (1 + percentage increase as a decimal) — for example, reverse a 25% increase by dividing the new value by 1.25." },
    { q: "What does a 0% change mean?", a: "A 0% change means the new value is exactly equal to the original value — no increase or decrease occurred." },
    { q: "Can this calculator handle negative starting values?", a: "It's designed for positive values; percentage change with negative original values can produce misleading results and should be interpreted carefully." },
    { q: "Is percentage change the same as growth rate?", a: "Yes, when comparing two time periods, percentage change and growth rate refer to the same calculation." },
    { q: "How do I calculate percentage change over multiple years?", a: "For a single overall change, use this calculator directly; for average annual change over multiple years, a CAGR calculation is more appropriate." },
  ],
