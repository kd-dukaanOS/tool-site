...
All decoding happens client-side; your token is never transmitted or stored.` },
  ...
  faq: [
    ...
    { q: "Can I edit and re-encode a JWT with this tool?", a: "No, this tool only decodes for inspection — re-encoding a valid signed token requires the original signing secret or private key." },
    { q: "Does this tool decode encrypted tokens (JWE)?", a: "No, this decodes standard signed JWTs (JWS). Encrypted JWE tokens have a different 5-segment structure and require the decryption key to read the payload at all." },
  ],
 relatedCalculators: ["Hash Generator", "UUID Generator", "Password Generator", "Base64 Encoder"],
  youMightAlsoLike: ["EMI Calculator", "Compound Interest Calculator", "GST Calculator", "Mortgage Calculator"],
